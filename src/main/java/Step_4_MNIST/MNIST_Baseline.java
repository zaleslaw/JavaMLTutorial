...
public class MNIST_Baseline {

    private static final Logger log = LoggerFactory.getLogger(MNIST_Baseline.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        lrSchedule.put(0, 0.005); // iteration #, learning rate
        lrSchedule.put(500, 0.0025);
        lrSchedule.put(750, 0.00125);
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .layer(3, new SubsamplingLayer.Builder(SubsamplingLayer.PoolingType.MAX)
                ...
                .stride(2, 2)
                .build())
            .layer(4, new DenseLayer.Builder().activation(Activation.SOFTMAX)
                .nOut(20).build())
